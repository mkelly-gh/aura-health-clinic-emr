          ...
          <div className="grid gap-6">
            ...
            <Card className="shadow-soft border-border">
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-secondary/30 rounded-lg border border-border flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    <Globe className="w-5 h-5 text-muted-foreground" />
                    <div>
                      <p className="text-sm font-semibold">Primary Region</p>
                      <p className="text-xs text-muted-foreground">Cloudflare Edge - Global</p>
                    </div>
                  </div>
                  <Badge className="bg-medical-stable text-white hover:bg-medical-stable/90">OPERATIONAL</Badge>
                </div>
